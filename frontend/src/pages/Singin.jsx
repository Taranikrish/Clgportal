...
export default function Signin() {
  ...
  // ✅ Handle Google OAuth callback (LOGIC FIX ONLY)
  useEffect(() => {
      ...
      <div className='flex flex-1 flex-col items-center justify-center'>
        ...
        <div className='relative mt-20 mb-8'>
          <div className='flex gap-x-14 md:gap-x-16 lg:gap-x-24 p-4'>
            <Link
              to="/Signin/student"
              className={`text-cyan-800/60 text-lg md:text-2xl ${
                role === 'student'
                  ? 'text-amber-900 underline underline-offset-16'
                  : ''
              }`}
            >
              Student
        ...
        <div className="flex flex-col gap-3 w-80">
          {role === 'student' && (
            <h2 className="text-cyan-800 text-center font-bold">
              Please sign-in using college email
            </h2>
          )}
